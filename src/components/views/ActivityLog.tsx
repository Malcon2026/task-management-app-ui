        ...
        <div style={{ maxWidth: 940, margin: '0 auto', padding: '28px 28px 48px', width: '100%' }}>
          ...
          <div style={{ marginBottom: 24 }}>
            <div style={{
              ...
              background: 'linear-gradient(135deg, #ffffff, #a855f7, #22d3ee)',
          ...
          <div className="stagger" style={{
            ...
            <StatPill label="Total Events" value={totalCount} icon="⚡" color="#6c5ce7" />
            ...
            <StatPill label="Active Users" value={activeUserIds} icon="👥" color="#cc5de8" />
          </div>
          ...
          <form onSubmit={handleAddComment} style={{
            ...
            <button
              ...
              style={{
                ...
                background: commentText.trim() ? 'linear-gradient(135deg, #6c5ce7, #a855f7)' : 'rgba(108, 92, 231, 0.2)',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
              ...
              <select
                ...
                style={{
                  padding: '9px 14px', background: 'rgba(18, 18, 42, 0.6)',
          ...
          {filtered.length === 0 ? (
            <div style={{
              ...
              background: 'rgba(14, 14, 36, 0.3)', borderRadius: 16, border: '1px dashed var(--border)',
            }}>
                      ...
                      <div key={a.id} style={{ display: 'flex', gap: 16, padding: '10px 0', position: 'relative' }}>
                        ...
                        {i < acts.length - 1 && (
                          <div style={{
                            ...
                            background: 'linear-gradient(180deg, rgba(108, 92, 231, 0.3), rgba(168, 85, 247, 0.1))',
                            zIndex: 1,
                          }} />
                        )}
                        ...
                        <div
                          ...
                          onMouseLeave={e => {
                            (e.currentTarget as HTMLElement).style.background = 'rgba(14, 14, 36, 0.55)';
                          ...
                          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
                            ...
                            <div style={{ fontSize: 14, color: 'var(--text-primary)', lineHeight: 1.5, flex: 1 }}>
                              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 4 }}>
                                <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontWeight: 700, color: '#e8e6f0' }}>
                                  <span
                              ...
                              {task && (
                                <div
                                  ...
                                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(108, 92, 231, 0.2)'; }}
                                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(108, 92, 231, 0.1)'; }}
                                >
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6, flexShrink: 0 }}>
                              ...
                              <span style={{
                                ...
                                background: 'rgba(18, 18, 42, 0.8)', color: 'var(--text-secondary)',
                                border: '1px solid var(--border)',
...
function FilterPill({ label, icon, active, onClick, count }: { label: string; icon?: string; active: boolean; onClick: () => void; count?: number }) {
  return (
    <button
      onClick={onClick}
      style={{
        padding: '5px 12px', borderRadius: 20, border: active ? '1px solid rgba(168, 85, 247, 0.4)' : '1px solid var(--border)',
        background: active ? 'linear-gradient(135deg, rgba(108, 92, 231, 0.25), rgba(168, 85, 247, 0.25))' : 'rgba(18, 18, 42, 0.6)',
        color: active ? '#ffffff' : 'var(--text-secondary)',
        fontSize: 12, fontWeight: active ? 600 : 500, cursor: 'pointer',
        display: 'inline-flex', alignItems: 'center', gap: 5,
        transition: 'all 0.2s',
        boxShadow: active ? '0 2px 10px rgba(108, 92, 231, 0.25)' : 'none',
      }}
      onMouseEnter={e => {
        if (!active) (e.currentTarget as HTMLElement).style.borderColor = 'rgba(108, 92, 231, 0.3)';
      }}
      onMouseLeave={e => {
    ...
    >
      ...
      {count !== undefined && (
        <span style={{
          ...
          background: active ? 'rgba(255, 255, 255, 0.2)' : 'rgba(108, 92, 231, 0.15)',
