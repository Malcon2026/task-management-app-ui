...
const TYPE_LABELS: Record<string, { label: string; color: string }> = {
  ...
  comment: { label: 'Commented', color: 'var(--text-muted)' },
};
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{
        ...
        {FILTERS.map(f => (
          <div
            ...
            onMouseEnter={e => { if (filter !== f.key) (e.currentTarget as HTMLElement).style.color = 'var(--text-secondary)'; }}
            onMouseLeave={e => { if (filter !== f.key) (e.currentTarget as HTMLElement).style.color = 'var(--text-muted)'; }}
          >{f.label}</div>
        ))}
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
          <input
            ...
            style={{
              ...
              color: 'var(--text-primary)', fontSize: 12, width: 140,
      ...
      <div style={{
        ...
        <input
          ...
          placeholder="Post a status note..."
          style={{
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }}>
                ...
                {targetUser && <span style={{ color: 'var(--text-secondary)' }}> → {getUserName(targetUser)}</span>}
              </div>
