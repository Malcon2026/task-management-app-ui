                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 13, color: 'var(--text-primary)', fontWeight: 500, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        <span style={{ fontWeight: 700, color: 'var(--text-primary)' }}>{getUserName(user)}</span>
                        {' '}<span style={{ color: 'var(--text-secondary)' }}>{act.text}</span>
                        {task && <span style={{ color: 'var(--accent)', fontWeight: 600 }}> "{task.title}"</span>}
            ...
            return (
              <div key={u.id} style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ height: 5, background: 'var(--bg-tertiary)', borderRadius: 6, overflow: 'hidden' }}>
                    <div style={{
          ...
          {todayTasks.map(t => (
            ...
            >
              <div
                ...
                style={{
                  width: 20, height: 20, border: `2px solid ${t.completed ? 'var(--green)' : 'var(--border-light)'}`,
  ...
  return (
    <div className="animate-fadeInUp" style={{
      ...
      <div style={{ flex: 1, position: 'relative' }}>
        ...
        {pct !== undefined && (
          <div style={{ height: 4, background: 'var(--bg-tertiary)', borderRadius: 6, overflow: 'hidden', marginTop: 10, width: '100%' }}>
            <div style={{
