        ...
        {TABS.map(tab => (
          <div
            ...
            style={{
              ...
              borderBottom: `2px solid ${filter === tab.key ? '#a855f7' : 'transparent'}`,
      ...
      {!isCollapsed && items.map(t => {
        ...
        return (
          <div
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLElement).style.background = 'rgba(14, 14, 36, 0.5)';
          ...
          >
            ...
            <div
              ...
              style={{
                width: 20, height: 20,
                border: `2px solid ${t.completed ? 'var(--green)' : 'rgba(108, 92, 231, 0.35)'}`,
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 4, flexShrink: 0 }}>
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(108, 92, 231, 0.1)'; (e.currentTarget as HTMLElement).style.color = 'var(--text-primary)'; }}
